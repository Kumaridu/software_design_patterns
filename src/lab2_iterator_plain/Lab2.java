...
public class Lab2 extends JFrame
{
	...
	void JButtonAllSwimmers_actionPerformed(ActionEvent event) {
		Iterator<Swimmer> iterator = slist.getVector().iterator();
...
//		}
	...
	void JButtonAllBackward_actionPerformed(ActionEvent event) {
		ReverseIterator<Swimmer> reverseIterator = new ReverseIterator(slist.getVector());
		while(reverseIterator.hasNext()) {
			Swimmer swimmer = reverseIterator.next();
			JTextArea1.append(swimmer.getFname()+" "+swimmer.getLname()+ " \n");
		}
...
//		}
	...
	void JButtonAllAbove12_actionPerformed(ActionEvent event) {
		SelectiveIterator selectiveIterator = new SelectiveIterator(slist.getVector(),
				age -> age >= 12);

		while(selectiveIterator.hasNext()) {
			Swimmer swimmer = selectiveIterator.next();
