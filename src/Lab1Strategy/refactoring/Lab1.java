...
public class Lab1 extends JFrame
{
    ...
    protected Tool eraserListener;
    protected Tool ovalListener;
    protected Tool rectangleListener;
    protected Tool scribbleListener;
    protected Tool lineListener;
	...
	public Lab1 ()
	{
        ...
        scribbleListener = new ScribbleTool(canvas);
        eraserListener = new EraseTool(canvas);

        lineListener = new TwoEndsTool(new LineShape(canvas));
        ovalListener = new TwoEndsTool(new OvalShape(canvas));
        rectangleListener = new TwoEndsTool(new RectShape(canvas));
  ...
  protected EventListener makeCanvasListener(ScribbleCanvas canvas) {
    return new ScribbleCanvasListenerRec(canvas,this);
  }
    ...
    protected void addToolbarButtons(JToolBar toolBar) {
         ...
         clearb = new JButton(new ImageIcon("Lab1Strategy/old/clear.gif"));
         ...
         scribbleb = new JButton(new ImageIcon("Lab1Strategy/old/scribble.gif"));
         ...
         lineb = new JButton(new ImageIcon("Lab1Strategy/old/line.gif"));
         ...
         rectangleb = new JButton(new ImageIcon("Lab1Strategy/old/rectangle.gif"));
         ...
         ovalb = new JButton(new ImageIcon("Lab1Strategy/old/oval.gif"));
         ...
         eraseb = new JButton(new ImageIcon("Lab1Strategy/old/eraser.gif"));
